...
(function() {
    ...
    $('[data-src="#form-apply"]').on("click", function(){
    	var title = $(this).attr("data-formapply-title") || null;
    	var value = $(this).attr("data-formapply-value") || null;
    	if( !(title || value) )
    		return;
    	$(".formapply-title").text(title);
    	$(".formapply-value").val(value).attr("value", value);
    })
